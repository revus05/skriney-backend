...
public class BankAccountApplicationService {
    ...
    @Transactional
    public BankAccountDTO createBankAccount(String userUuid, CreateBankAccountRequestDTO requestBody) {
    ...
    @Transactional
    public BankAccountDTO updateBankAccount(String uuid, UpdateBankAccountRequestDTO dto, String userUuid)
    ...
    private List<BankAccountDTO> getBankAccountsDTOWithCurrencyBalance(List<BankAccount> bankAccounts) {
