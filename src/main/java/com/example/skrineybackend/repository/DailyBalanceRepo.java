...
public interface DailyBalanceRepo extends CrudRepository<DailyBalance, String> {
    ...
    Optional<DailyBalance> findTopByBankAccount_UuidAndDateBeforeOrderByDateDesc(String bankAccountUuid, LocalDate date);
    ...
    List<DailyBalance> findAllByBankAccount_UuidAndDateBetweenOrderByDateAsc(String bankAccountUuid, LocalDate startDate, LocalDate endDate);
}
