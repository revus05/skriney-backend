...
public interface TransactionRepo extends CrudRepository<Transaction, String> {
    ...
    List<Transaction> findByUser_UuidAndBankAccount_UuidAndCreatedAtGreaterThanEqualOrderByCreatedAtDesc(String userUuid, String bankAccountUuid, Instant fromDateTime);
    List<Transaction> findByUser_UuidAndCreatedAtGreaterThanEqualOrderByCreatedAtDesc(String userUuid, Instant fromDateTime);
...
""")
    List<CategoryStatDTO> getUserCategoryStats(String userUuid, Instant startDate, String bankAccountUuid);
}
