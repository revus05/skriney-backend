...
class UserControllerTest extends AbstractIntegrationTest {
    ...
    void signIn_User_ValidRequest_ReturnsSuccessResponse() throws Exception {
        SignUpUserRequestDTO signUpBody = new SignUpUserRequestDTO(
                "testusername",
                "testemail@gmail.com",
                "testpassword"
        );
        ...
        SignInUserRequestDTO requestBody = new SignInUserRequestDTO("testemail@gmail.com", "testpassword");
    ...
    void updateImage_User_InvalidToken_ReturnsErrorResponse() throws Exception {
        mockMvc.perform(patch("/users/update-image")
                        .contentType(MediaType.APPLICATION_JSON)
